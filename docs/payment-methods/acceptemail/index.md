...
## JSON Object 
```json
 {"code":"acceptemail","vendor":"acceptemail","name":{"en":"AcceptEmail"},"description":{"en":"From now on, your bills will be sent directly to your inbox on your computer, tablet or mobile. No more deposit transfers that end up in a drawer, no more losing bills or logging in on supplier sites. AcceptEmail makes paying bills easy!"},"countries":["AX","AL","AD","AU","BY","BE","BA","BG","HR","CZ","DK","EE","FO","FJ","FR","DE","GI","GR","GG","HU","IS","IM","IT","JE","LV","LI","LT","LU","ML","MD","MC","ME","NL","NO","PT","RO","SM","RS","SK","ZA","ES","SJ","SE","CH","RW","AE","UM"],"category":"invoice_payment"}```  
