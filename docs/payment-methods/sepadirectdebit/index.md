...
## JSON Object 
```json
 {"code":"sepadirectdebit","vendor":"sepadirectdebit","name":{"en":"SEPA Direct Debit"},"description":{"en":"The SEPA Direct Debit enables to make pan-European collections in euro's on a one-off or recurrent basis.\u00a0"},"countries":["AL","AD","AU","BY","BE","BA","BG","HR","CZ","DK","EE","FO","FJ","FR","DE","GI","GR","GG","HU","IS","IM","IT","JE","LV","LI","LT","LU","ML","MD","MC","ME","NL","NO","PT","RO","SM","RS","SK","ES","SJ","SE","CH"],"category":"direct_debit"}```  
