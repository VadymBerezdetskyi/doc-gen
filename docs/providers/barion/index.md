...
## JSON Object 
```json
 {"code":"barion","description":null,"vendor":"barion","categories":null,"countries":["AU","BE","CY","EE","FJ","FR","DE","GI","GR","HU","IS","IM","IT","LV","LI","LT","LU","NL","PT","SK","ES"],"payment_method":null,"payout_method":null,"metadata":{"about_payments_code":"barion"},"name":{"en":"Barion Payments"}}```  
