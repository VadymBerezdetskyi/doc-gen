...
## JSON Object 
```json
 {"code":"paylike","description":null,"vendor":"paylike","categories":null,"countries":["AU","BE","BG","HR","CY","CZ","DK","EE","FO","FJ","FR","DE","GR","HU","IS","IT","LV","LI","LT","LU","ML","NL","NO","AX","PT","RO","SM","SK","ES","SE","CH","AE"],"payment_method":null,"payout_method":null,"metadata":{"about_payments_code":"paylike"},"name":{"en":"Paylike"}}```  
