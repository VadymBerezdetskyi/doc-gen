...
## JSON Object 
```json
 {"code":"virtualxs","description":null,"vendor":"virtualxs","categories":null,"countries":["NL"],"payment_method":null,"payout_method":null,"metadata":{"about_payments_code":"virtualxs"},"name":{"en":"Virtual Access"}}```  
