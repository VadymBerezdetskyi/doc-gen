...
## JSON Object 
```json
 {"code":"netpayinternational2","description":null,"vendor":"netpayinternational2","categories":["distributing","aggregating","collecting"],"countries":null,"payment_method":["visa2","mastercard","sofortbanking","ideal"],"payout_method":null,"metadata":{"about_payments_code":"netpayinternational2"},"name":{"en":"NetPay International"}}```  
