...
## JSON Object 
```json {"code":"astropay","description":null,"vendor":"astropay","categories":null,"countries":["AR","BO","BR","CL","CO","CR","EC","MX","CA","PY","PE","VE"],"payment_method":null,"payout_method":null,"metadata":{"about_payments_code":"astropay"},"name":{"en":"AstroPay"}} ``` 
