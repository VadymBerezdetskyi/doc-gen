## General 
**Code:** `kasikorn_bank_thb`  
**Method:** `kasikorn_bank`  
**Currency:** `THB` [show -->]() 
**Amount limits:** from `350`  to `175000`  THB ## Fields 
### Overview 
